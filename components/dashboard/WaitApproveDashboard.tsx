...
const WaitApproveDashboard = () => {
  ...
  async function getDashboardData() {
    const data = await DashboardService.waitApprove().then((res: any) => {
      return res.result;
    });
    const thaiData = data.wait_approve_th;
    const laosData = data.wait_approve_ls;
    const myanmarData = data.wait_approve_mm;
    const cambodiaData = data.wait_approve_cd;
    setTotalData(data.wait_approve_total);
    const newArray = [
...
export default WaitApproveDashboard;
